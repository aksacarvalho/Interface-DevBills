          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white mb-8">
                Uma plataforma simples e eficiente para controlar suas despesas e receitas. Organize suas finanças pessoais ou do seu negócio com facilidade.
              </p>
          ...
          <div className="container-app">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-white max-w-2xl mx-auto">
                Nossa plataforma oferece tudo o que voçê precisa para manter suas finanças
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature) => (
                <div 
                  ...
                  <div className="mb-4 bg-primary-gray-500/10 p-3 rounded-full inline-block">
                    {feature.icon}
                  </div>
